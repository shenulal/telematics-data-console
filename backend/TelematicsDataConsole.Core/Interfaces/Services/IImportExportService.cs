...
public interface IImportExportService
{
    ...
    Task<byte[]> GetTagsImportTemplateAsync();

    // Tag Items (for ManageItems modal)
    Task<List<ExportTagItemDetailDto>> ExportTagItemsAsync(int tagId, short? entityType = null);
    Task<byte[]> ExportTagItemsToExcelAsync(int tagId, short? entityType = null);
    Task<ImportResultDto> ImportTagItemsByIdentifierAsync(int tagId, short entityType, List<ImportTagItemByIdentifierDto> items);
    Task<ImportResultDto> ImportTagItemsFromExcelAsync(int tagId, short entityType, Stream fileStream);
    Task<byte[]> GetTagItemsImportTemplateAsync(short entityType);
    ...
    Task<byte[]> GetTechniciansImportTemplateAsync();
    ...
    Task<byte[]> GetResellersImportTemplateAsync();
    ...
    Task<byte[]> GetUsersImportTemplateAsync();
    ...
    Task<byte[]> GetRolesImportTemplateAsync();
}
